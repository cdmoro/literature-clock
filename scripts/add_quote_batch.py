...
def add_quote_to_csv(time_val, quote_time, quote, author, title, language_code, sfw_status):
    for lang_code in languages:
        ...
        # Write to the CSV (time, translated quote time, translated quote, translated title, author, sfw_status)
        with open(file_path, mode='a', newline='', encoding='utf-8') as file:
            writer = csv.writer(file)
            writer.writerow([time_val, translated_quote_time, translated_quote, translated_title, author, sfw_status])
